      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        ...
        >
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button disabled={loading} className="w-full py-4 bg-[#0066FF] hover:bg-[#0052cc] text-white rounded-2xl font-black text-[11px] capitalize tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20">
