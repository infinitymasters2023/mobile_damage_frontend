            ...
            <nav className={`fixed top-0 left-0 right-0 w-full z-[100] transition-all duration-500 ${scrolled ? 'bg-black/80 backdrop-blur-xl py-4 shadow-2xl' : 'py-8'}`}>
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/login" className="hidden md:block bg-blue-600 hover:bg-blue-500 px-8 py-2.5 rounded-full text-xs font-black text-white transition-all shadow-lg shadow-blue-600/20">
                            LOGIN
                        </Link>
