    ...
    <div className="h-screen w-full flex flex-col bg-[#020202] text-slate-200 font-sans selection:bg-blue-500/30 overflow-hidden">
      ...
      <main className="flex-grow flex p-6 gap-6 overflow-hidden">
        ...
        <div className="flex-grow flex flex-col gap-6 overflow-hidden">
          ...
          {/* DATA TERMINAL */}
          <div className="flex-[4] bg-black rounded-[2rem] border border-white/5 flex flex-col overflow-hidden shadow-2xl">
            <div className="px-8 py-4 border-b border-white/5 flex justify-between items-center bg-white/[0.01]">
              ...
              {activeTask?.vPath && <span className="text-[8px] font-mono text-emerald-500/40 truncate max-w-[300px]">NODE: {activeTask.vPath}</span>}
            </div>
            <div className="flex-grow p-8 font-mono text-[13px] text-emerald-400/90 overflow-y-auto scrollbar-hide">
