...
const DOC_CONFIG = [
  { id: "Excel_only", label: "Excel Only", endpoint: "/upload/reliance" },
  { id: "Purchase_order", label: "Purchase Order", endpoint: "/upload/reliance" }, 
];
...
export default function EnterpriseOCR() {
  ...
  const [selectedType, setSelectedType] = useState("Excel_only"); 
